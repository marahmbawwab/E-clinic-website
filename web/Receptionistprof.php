...
<head>
    ...
    if(isset($_POST['edittt'])){
        ...
        $sql = "UPDATE `receptioest` SET rfname='$fname',rlname='$lname' ,rage='$age',raddress='$address' ,rphone='$phone',remail='$email',rgender ='$gender' WHERE rid='$id'";
                                    ...
                                    <div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                        <div class="slider-text-inner js-fullheight">
                                            <div class="input-group">
                                                <form method="post" action="Receptionistprof.php">
                                                    <table >
                                                        <tr>
