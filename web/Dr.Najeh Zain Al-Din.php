            ...
            <div style=" margin-right: 70px;"align="center" class="col-12 col-md-6 col-lg-5 mt-5 mt-lg-0">
                <div  style="width:450px; height:320px"class="opening-hours" >
                    ...
                    <ul class="p-0 m-0">
                        ...
                        <li><div><img src="images/mobile.png" width="80px" height="80px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=" float:right;font-weight: bolder;font-size: x-large">  0599785530</span></div></li>
