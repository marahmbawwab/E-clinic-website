...
<head>
    ...
    $u=$_GET['c'];
    $sq3 = "SELECT * FROM `receptioest` WHERE ruser='$u'";
    ...
    <div class="container-wrap">
        ...
        <aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="background-color: #a6e1ec">
            <div class="text-center">
                ...
                <form action="workingtimetabledocbyrece.php" method="GET">
                ...
                <nav id="colorlib-main-menu" role="navigation" class="navbar">
                    ...
                    <ul>
                        <ul>
                            ...
                            <li><a href="viewdoctimebyrece.php?c=<?php echo $u?>" style="color: #bd2130;font-weight: bold" >View Doctor's Working time</a></li>
                            ...
                            <div class="row row-space" data-animate-effect="fadeInLeft">
                                <div class="col-2">
                                    <div class="input-group">
                                        <form method="POST" action="workingtimetabledocbyrece.php">
                                            <table>
...
<td style='font-weight: bolder; ;font-size:18px;color:#204d74'>$end</td></tr>";
                                                        $row = $result1->fetch_assoc();
                                                    }
                                                    echo "</table>";
