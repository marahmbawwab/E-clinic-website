...
<div class="container-wrap">
    ...
    <aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="background-color: #a6e1ec">
        <div class="text-center">
            ...
            <form action="viewdoctimebyrece.php" method="GET">
            ...
            <nav id="colorlib-main-menu" role="navigation" class="navbar">
                ...
                <ul>
                    ...
                    <li><a href="#" style="color: #bd2130;font-weight: bold">View Doctor's Working time</a></li></ul>
            </nav>
                            ...
                            <div class="row row-space" data-animate-effect="fadeInLeft">
                                <div class="col-2">
                                    <div class="input-group">
                                        <form method="post" action="viewdoctimebyrece.php">
                                            <table >
                                            ...
                                            if (!$result3 && !$result4 && !$result5 &&!$result6 &&!$result7 &&!$result8) {
                                                ...
                                                if ($result8->num_rows != 0) {
                                                    ...
                                                    while ($row = $result8->fetch_assoc()) {
                                                        ...
                                                        $ln = $row["lname"];
                                                        $iiid=$row["id"];
                                                        echo "<tr><td><a style=' text-decoration:underline ;color:#204d74;font-size:18px' href='workingtimetabledocbyrece.php?h=$iiid & l=$iid & c=$u'> $fn  $ln </a></td></tr>";
                                                    }
