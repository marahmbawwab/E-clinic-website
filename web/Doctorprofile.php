...
<head>
    ...
    if(isset($_POST['edittt'])){
        ...
        $sql = "UPDATE `doctor` SET fname='$fname',lname='$lname' ,age='$age',address='$address' ,phone='$phone',email='$email',dgender ='$gender' WHERE id='$id'";
    ...
    <div class="container-wrap">
        ...
        <aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="background-color: #a6e1ec">
            <div class="text-center">
                ...
                <form method="get" action="Doctorprofile.php">
                <h1  id="colorlib-logo"><a  name='c' href="#"><?php echo $fn.$ln."\n\n".'username:'.$user?></a></h1>
                </form>
            </div>
            <nav id="colorlib-main-menu" role="navigation" class="navbar">
                <ul>
                    <li class="active"><a href="#" data-nav-section="Profile" style="color: #bd2130;font-weight: bold"> Profile</a></li>
                                                ...
                                                <form method="post" action="Doctorprofile.php">
                                                    <table >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="input--style-4" type="email" id="email"  value="<?php  echo $email?>"name="email">
...
<tr>
    ...
    <td><br></td></tr><tr>
                                                        ...
                                                        <td>
                                                            <input class="input--style-4" type="text" id="major"  value="<?php  echo $major?>"name="major">
